...
if (isset($_GET['sso'])) {
    ...
    if (isset($_POST['RelayState']) && OneLogin_Saml2_Utils::getSelfURL() != sanitize_text_field(wp_unslash($_POST['RelayState'])) {
        $auth = sanitize_text_field(wp_unslash(($_POST['RelayState']));
    }
